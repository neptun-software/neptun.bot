...
├── tech_stack_ai_configuration_data_scraper             # The main python package for the project
...
e.g: `cat tech_stack_ai_configuration_data_scraper/VERSION` will get the project version without harming
